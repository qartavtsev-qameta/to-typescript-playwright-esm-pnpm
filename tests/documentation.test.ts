...
test('Должен перейти на страницу "Информация о релизах ТестОпс" через боковую панель', async ({ page }) => {
  ...
  await allure.step('Нажать на пункт "Информация о релизах" на боковой панели', async () => {
...
test('Должен перейти на страницу "Часто задаваемые вопросы" через боковую панель', async ({ page }) => {
  ...
  await allure.step('Нажать на пункт "Часто задаваемые вопросы" на боковой панели', async () => {
...
test('Должен перейти на страницу "Архитектура ТестОпс" через боковую панель', async ({ page }) => {
  ...
  await allure.step('Нажать на пункт "Установка ТестОпс" на боковой панели, чтобы раскрыть подпункты', async () => {
    await page.click('text=Установка ТестОпс');
  });
  
  await allure.step('Нажать на подпункт "Архитектура"', async () => {
...
test('Должен перейти на страницу "Способы установки ТестОпс" через ссылку', async ({ page }) => {
  ...
  await allure.step('Проверить, что заголовок на странице включает "Способы установки ТестОпс"', async () => {
...
test('Должен перейти на страницу "Термины и определения" через ссылку (намеренно сломанный)', async ({ page }) => {
  ...
  await allure.step('Проверить, что заголовок на странице включает "Термины и определения"', async () => {
